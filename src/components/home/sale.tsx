...
export default function Sale() {
  return (
    <section>
      ...
      >
        <div className="flex flex-col justify-between items-center md:pt-[500px] pt-[200px] lg:px-[200px] px-[50px]">
          <div className="flex flex-col w-full  justify-start items-start">
            <button className="rounded-[20px] bg-[#3B3B3B] px-[30px] py-[10px] justify-center">
              Trusted Seller
            </button>
            <span className="md:text-[51px] text-[42px] font-[600] ">
              10% Off Sale
            </span>
          </div>
          <div className="flex md:flex-row flex-col-reverse w-full justify-between items-center md:mt-0 mt-50">
            ...
            <div className="flex flex-col items-start justify-center bg-[#3B3B3B] w-[295px] h-[144px] px-[30px] py-[30px]  rounded-[20px] mb-[40px] gap-10">
              <span>Sale ends in:</span>
              <div className="flex flex-row w-full space-x-15 justify-center items-center">
                <div className="flex flex-col items-center">
                  <span className="text-[#FFF]  text-[38px] font-[700]">
                    59
                  </span>
                  <span>Hours</span>
                </div>
