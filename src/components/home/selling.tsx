    ...
    <section>
      ...
      >
        <div className="flex md:flex-row flex-col justify-between md:items-center items-start">
          ...
          <div className="md:block hidden md:w-[180px] w-full">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-35 justify-center items-center mt-[20px]">
          {SellingData.map((item, key) => (
            <div
              key={key}
              className="bg-[#3B3B3B] relative p-[10px] rounded-[20px] w-full h-full min-w-[250px] flex justify-center  items-center cursor-pointer"
            >
              <Image
        ...
        <div className="md:hidden block md:w-[180px] w-full mt-30">
          <button className="flex flex-row w-full md:w-[180px] rounded-[10px] h-[40px] gap-[12px] px-5 py-0 items-center justify-center border-[#A259FF] border-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
