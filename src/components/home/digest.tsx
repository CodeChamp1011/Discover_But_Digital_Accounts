...
import { HomeImage } from "@/assets/images/_images";
    ...
    <section>
      <div className="bg-black-gray xl:px-[255px] px-[20px] flex md:flex-row flex-col justify-between items-center py-[120px]">
        <div className="flex flex-col lg:w-[510px] md:w-[300px] h-full items-start space-y-55">
          ...
          <button className="flex flex-row md:w-[180px] w-full gradient-btn1 rounded-[20px] h-[40px] gap-[12px] px-5 py-0 items-center justify-center">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M6.17053 12.4491C6.28055 12.7763 6.10451 13.1307 5.77734 13.2407C4.71792 13.597 4.15489 14.4863 3.85373 15.3907C3.73414 15.7498 3.66189 16.0955 3.61848 16.3814C3.90434 16.338 4.25006 16.2657 4.60917 16.1462C5.51355 15.845 6.4029 15.282 6.75916 14.2225C6.86918 13.8954 7.2236 13.7193 7.55078 13.8294C7.87795 13.9394 8.05399 14.2938 7.94396 14.621C7.4096 16.21 6.08801 16.9712 5.00411 17.3321C4.45655 17.5145 3.94395 17.6045 3.5698 17.6494C3.38182 17.6719 3.22641 17.6833 3.116 17.6892C3.06074 17.6921 3.01658 17.6936 2.98505 17.6944C2.96928 17.6947 2.95666 17.695 2.94737 17.6951L2.93596 17.6952L2.93217 17.6952L2.93077 17.6952L2.93019 17.6952C2.92993 17.6952 2.92969 17.6952 2.92969 17.0702C2.30469 17.0702 2.30469 17.07 2.30469 17.0697L2.30469 17.0691L2.30469 17.0677L2.30471 17.0639L2.30481 17.0525C2.30493 17.0432 2.30514 17.0306 2.30553 17.0148C2.30631 16.9833 2.30782 16.9391 2.31072 16.8839C2.31653 16.7735 2.32797 16.6181 2.35052 16.4301C2.3954 16.0559 2.48542 15.5433 2.66776 14.9958C3.0287 13.9119 3.78989 12.5903 5.37891 12.0559C5.70608 11.9459 6.0605 12.1219 6.17053 12.4491ZM2.92969 17.0702H2.30469C2.30469 17.4154 2.58451 17.6952 2.92969 17.6952V17.0702Z"
                fill="white"
              />
              <path
                fill-rule="evenodd"
          ...
          <div className="flex flex-row w-full min-w-max justify-between mt-[70px]">
            <div className="flex flex-col space-y-15">
              <span className="text-[28px] font-[700] leading-4">240k+</span>
              <span className="text-[24px] font-[400] leading-3">
                Total Sale
              </span>
            </div>
            <div className="flex flex-col space-y-15">
              <span className="text-[28px] font-[700] leading-4">240+</span>
              <span className="text-[24px] font-[400] leading-3">
                Account Types
              </span>
            </div>
